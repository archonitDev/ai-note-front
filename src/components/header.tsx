...
import { NewRecordModal } from "./new-record-popup";
      ...
      <header className="overflow-hidden gap-10 relative flex flex-col md:flex-row justify-between items-center rounded-xl md:rounded-full px-4 sm:px-6 lg:px-8 py-3 w-full bg-white">
        ...
        <div className="flex flex-row items-center gap-2 sm:gap-6 flex-shrink-0">
          <button
            ...
            className="flex items-center justify-center px-3 sm:px-6 py-3 text-sm font-medium text-white bg-[#F08524] rounded-full transition-all duration-200 hover:bg-[#e07616] whitespace-nowrap"
          >
            Start Record
          </button>
          <UserProfile
